...
class DriverInResponse {
  ...
  dynamic _adharBackImg;
  dynamic _vehicleImg;
  dynamic _driverVehicleImg;
  String? _panCardImg;
...
DriverInResponse copyWith({  String? id,
  ...
  dynamic get certificateImg => _certificateImg;
  ...
  dynamic get totalRating => _totalRating;
