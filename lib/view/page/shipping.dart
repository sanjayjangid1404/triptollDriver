...
class _PrivacyPolicyPageState extends State<Shipping> {
  String htmlContent = "";
  ...
  Future<void> loadHtml() async {
    final String fileText = await rootBundle.loadString("assets/shipping.html");
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Shipping Policy".tr,style: TextStyle(color: Colors.black),),
