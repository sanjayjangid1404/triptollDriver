...
class AuthController extends GetxController implements GetxService
{
  ...
  //  LoginResponse? loginResponse;
    ...
    if(response.statusCode==200 || response.statusCode ==400)
    {
      ...
      if(response.body["status"].toString() == "false"){
        ...
        if(response.body["category_id"]!=null && response.body["category_id"].isNotEmpty && response.body["category_id"].toString() !="0"){
  ...
  //  LoginResponse? loginResponse;
    ...
    if(response.statusCode==200 || response.statusCode ==400)
    {
      if(response.body["data"]!=null){
        Get.to(VehicleDocumentUploadView(id: response.body["data"]["driver_id"].toString(),));
      }
  ...
  Future<void>updateDriverKyc(body,BuildContext context, {XFile? adhaarF,XFile? adhaarb,XFile? panImage,XFile? licenseNumberB,XFile? lienB,XFile? insur,bool isEdit = false})
  async {
  ...
  //  LoginResponse? loginResponse;
    ...
    if(licenseNumberB!=null){
      multipartBody.add(MultipartBody("license_front", XFile(licenseNumberB.path)));
    }
    ...
    if(response.statusCode==200)
    {
      ...
      if(isEdit){
        ...
        Get.to(BankDetailView(driverID: response.body["driver_id"].toString(),));
      }
  ...
  Future<void>updateDriverBankDetail(body,BuildContext context,{bool isEdit = false})
  async {
  ...
  async {
    ...
    Response response = await authRepo.vehicleDetailsUpload(body,multipartBody);
  ...
  Future<void>updateDriverVehicle({String? orderID})
  async {
    ...
    Response response = await authRepo.updateDriverVehicle(userID: getUserID(),category_id: orderID);
